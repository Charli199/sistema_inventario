    ...
    private void calcularTotalInventario() {
        productosRef.orderByChild("productState").equalTo("Disponible").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                tvTotalInventorySummary.setText("Resumen del Inventario:" + "\n - Costo total del inventario Disponible: $" + totalInventoryValue + "\n");
            }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (producto.getProductState().equals("Disponible")) {
                        ...
                        productsBySectionSummary.append(" - ").append("Ubicación: ").append(section).append(", Producto: ").append(productName).append("\n");
                    }
                }
        ...
        productosRef.orderByChild("productPrice").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < Math.min(5, productos.size()); i++) {
                    ...
                    mostExpensiveProductsSummary.append(" - ").append(producto.getProductName()).append(": $").append(producto.getProductPrice()).append("\n");
                }
    ...
    private void calcularProductosMasEconomicos() {
        productosRef.orderByChild("productPrice").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < Math.min(5, productos.size()); i++) {
                    Producto producto = productos.get(i);
                    cheapestProductsSummary.append(" - ").append(producto.getProductName()).append(": $").append(producto.getProductPrice()).append("\n");
                }
